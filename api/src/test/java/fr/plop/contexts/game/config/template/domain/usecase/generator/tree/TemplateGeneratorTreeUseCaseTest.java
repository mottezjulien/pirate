...
public class TemplateGeneratorTreeUseCaseTest {

    private final TemplateGeneratorTreeUseCase generator = new TemplateGeneratorTreeUseCase();

    @Test
    public void emptyDefaultTemplate() {
        TemplateGeneratorTreeUseCase.Script script = new TemplateGeneratorTreeUseCase.Script("ABCD");
    ...
    public void versionAndLabel() {
        TemplateGeneratorTreeUseCase.Script script = new TemplateGeneratorTreeUseCase.Script("XYZ:1.8.4:Mon nouveau niveau");
        Template template = generator.apply(script);
        assertThat(template).isNotNull();
        assertThat(template.id()).isNotNull();
    ...
    public void versionAndLabelAndDuration() {
        TemplateGeneratorTreeUseCase.Script script = new TemplateGeneratorTreeUseCase.Script("POUET:1.4:Mon nouveau niveau 2:180");
        Template template = generator.apply(script);
        assertThat(template).isNotNull();
        assertThat(template.id()).isNotNull();
    ...
    public void oneStepWithTargets() {
        TemplateGeneratorTreeUseCase.Script script = new TemplateGeneratorTreeUseCase.Script("""
                Coucou:2::30
        ...
        assertThat(template.board().spaces())
                ...
                .anySatisfy(board -> {
                    ...
                    assertThat(board.rectangles())
                            .hasSize(2)
                            .anySatisfy(rect -> {
                                assertThat(rect.bottomLeft()).isEqualTo(Point.from(5.7F, 10));
                                assertThat(rect.topRight()).isEqualTo(Point.from(8.097F, 50.43F));
                            })
                            .anySatisfy(rect -> {
                                assertThat(rect.bottomLeft()).isEqualTo(Point.from(10, 20));
                                assertThat(rect.topRight()).isEqualTo(Point.from(8.56F, 9));
                            });
                });
    }
        ...
        assertThat(template.board().spaces())
                ...
                .anySatisfy(board -> {
                    ...
                    assertThat(board.rectangles())
                            .hasSize(2)
                            .anySatisfy(rect -> {
                                assertThat(rect.bottomLeft()).isEqualTo(Point.from(5.798F, 10.894F));
                                assertThat(rect.topRight()).isEqualTo(Point.from(45.98F, 50.4338F));
                            })
                            .anySatisfy(rect -> {
                ...
                .anySatisfy(board -> {
                    ...
                    assertThat(board.rectangles())
                            .hasSize(1)
                            .anySatisfy(rect -> {
                                assertThat(rect.bottomLeft()).isEqualTo(Point.from(89.745F, 5.5684F));
                                assertThat(rect.topRight()).isEqualTo(Point.from(0.8547F, 8.147F));
                            });
                });
    }
