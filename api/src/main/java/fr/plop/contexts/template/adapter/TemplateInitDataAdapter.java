package fr.plop.contexts.template.adapter;
...
import fr.plop.contexts.board.persistence.repository.BoardRectRepository;
import fr.plop.contexts.board.persistence.repository.BoardRepository;
import fr.plop.contexts.board.persistence.repository.BoardSpaceRepository;
...
import fr.plop.contexts.scenario.persistence.core.ScenarioRepository;
import fr.plop.contexts.scenario.persistence.core.ScenarioStepEntity;
import fr.plop.contexts.scenario.persistence.core.ScenarioStepRepository;
import fr.plop.contexts.scenario.persistence.core.ScenarioTargetEntity;
import fr.plop.contexts.scenario.persistence.core.ScenarioTargetRepository;
import fr.plop.contexts.scenario.persistence.possibility.ScenarioPossibilityEntity;
import fr.plop.contexts.scenario.persistence.possibility.ScenarioPossibilityRepository;
import fr.plop.contexts.scenario.persistence.possibility.condition.ScenarioPossibilityConditionRepository;
import fr.plop.contexts.scenario.persistence.possibility.condition.entity.ScenarioPossibilityConditionAbstractEntity;
import fr.plop.contexts.scenario.persistence.possibility.consequence.ScenarioPossibilityConsequenceRepository;
import fr.plop.contexts.scenario.persistence.possibility.consequence.entity.ScenarioPossibilityConsequenceAbstractEntity;
import fr.plop.contexts.scenario.persistence.possibility.trigger.ScenarioPossibilityTriggerRepository;
