...
public class GameController {
    ...
    public GameController(ConnectUseCase connectUseCase, GameCreateSessionUseCase createUseCase, GameMoveUseCase moveUseCase) {
    ...
    public GameCreateResponse create(
        ...
        try {
            ...
            GameSession.Atom game = createUseCase.apply(templateCode, user.id());
    ...
    public GameMoveResponseDTO move(
        ...
        try {
            ConnectUser user = connectUseCase.findUserIdByRawToken(new ConnectToken(rawToken));
            GameSession.Id gameId = new GameSession.Id(gameIdStr);
